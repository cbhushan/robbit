...
//! Class to store dats required to 
/*! Stores data required to render a frame. On update of values of Frame_Data object, the
data here must be updated.
*/
class Frame_Display : public Fl_Gl_Window {
 ...
 public:
  ...
  int current_index;
  float view_centerX,view_centerY,view_centerZ;
								//stores the position to which the camera is directed

  int handle(int event);
  void UpdateFrame(Frame_Data _data);
