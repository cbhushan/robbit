...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *	
*	WriteInputFile.h  v 3.0 , 2007-12-05, 10:47:00 IST
*
*	Write the input file output_pos.log in case frame_update_mode = 1
*	with the generated data (location, velocity etc)
*
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
